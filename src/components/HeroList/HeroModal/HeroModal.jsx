...
const HeroModal = ({ hero, onOk, onCancel }) => {
  ...
  const handleSave = () => {
    onOk(heroToAdd).then(
      (r) => r.type !== "users/addHero/rejected" && history.push("/")
    );
  };
  ...
  const validateForm = () =>
    !Object.values(heroToAdd).some((value) => value === "" || !value);
      ...
      {hero === "NEW" ? (
        <>
          <img
            ...
            width={94}
            height={94}
            src={"http://localhost:4000/assets/avocado.png"}
          />
          <Form
            layout="vertical"
            className="HeroModal__heroForm"
          ...
          >
            ...
            >
              <Select
                ...
                onChange={(value) =>
                  setHeroToAdd({ ...heroToAdd, type: value })
                }
              >
                {loading ? (
                  <Select.Option value={null}>Loading...</Select.Option>
                ) : (
        ...
        hero && (
          <>
            ...
            <div className="HeroModal__heroName">
              ...
              <Typography.Title level={5} className="type" type="secondary">
                {hero.type.name}
              </Typography.Title>
            </div>
